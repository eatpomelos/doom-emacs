...
(setq +org-capture-todo-file (expand-file-name "todo.org" pomelo-org-directory )
      +org-capture-journal-file (expand-file-name "journal.org" pomelo-org-directory )
      +org-capture-notes-file (expand-file-name "notes.org" pomelo-org-directory )
      )
